              ...
              {familyGroups.map((group) => (
                ...
                >
                  ...
                  <div className="mt-3 grid gap-2 rounded-2xl border border-[var(--color-border)] bg-[var(--bg-inset)] p-3 text-xs text-[var(--color-muted)]">
                    <p>
                      <span className="font-medium text-[var(--color-on-surface)]">De ce conteaza:</span>{" "}
                      {group.familyImpact}
                    </p>
                    <p>
                      <span className="font-medium text-[var(--color-on-surface)]">Ce dovedeste:</span>{" "}
                      {group.proofSummary}
                    </p>
                    <p>
                      <span className="font-medium text-[var(--color-on-surface)]">Surse in scope:</span>{" "}
                      {group.sourceDocuments.length > 0 ? group.sourceDocuments.join(" · ") : "fara surse legate inca"}
                    </p>
                    <p>
                      <span className="font-medium text-[var(--color-on-surface)]">Presiune curenta:</span>{" "}
