  ...
  return (
    <div className="space-y-8">
      <PageIntro
        ...
        description="Aici ruleaza queue-ul canonic de actiune. Vault si Rapoarte raman suprafete read-only de verificare, nu locul in care inchizi task-uri."
        badges={
          <>
              ...
              {tasksMissingEvidence.length > 0
                ...
                : ledgerWeakCount > 0
                  ...
                  : openPriorityOneTasks.length > 0
                    ...
                    : "Poti lucra direct din queue fara blocaje majore."}
            </p>
          </div>
        }
      />
