...
const REPORTS_TABS = [
  {
    ...
    matchers: [dashboardRoutes.reports, dashboardRoutes.reportsLegacy],
    icon: FileSearch,
  },
  {
    id: "policies",
    ...
    matchers: [dashboardRoutes.policies, dashboardRoutes.policiesLegacy],
    icon: BookOpen,
  },
  {
    id: "audit-log",
    ...
    matchers: [dashboardRoutes.auditLog, dashboardRoutes.auditLogLegacy],
    icon: ClipboardList,
  },
  {
    id: "trust-center",
    ...
    matchers: [dashboardRoutes.trustCenter, dashboardRoutes.trustCenterLegacy],
    icon: ShieldCheck,
  },
] as const
