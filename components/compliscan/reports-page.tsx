...
import { Archive, Briefcase, ChevronRight, Copy, FileCheck2, Loader2, Scale, Share2 } from "lucide-react"
...
export function ReportsPageSurface() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Vault — Documente generate automat (GOLD 7) */}
  ...
  return (
    <Card className="border-eos-border bg-eos-surface">
        ...
        <div className="flex flex-wrap items-start justify-between gap-2">
          <div>
            <CardTitle className="flex items-center gap-2 text-base">
              <Archive className="size-4 text-eos-primary" strokeWidth={2} />
      ...
      <CardContent className="pt-0">
          ...
          {recent.map((doc) => {
            ...
            return (
              <div key={doc.id} className="flex flex-wrap items-center gap-3 py-3">
                <FileCheck2 className="size-4 shrink-0 text-eos-primary" strokeWidth={2} />
                <div className="min-w-0 flex-1">
                  <p className="text-sm font-medium text-eos-text">{doc.title}</p>
                  <div className="mt-0.5 flex flex-wrap items-center gap-2">
                    <span className="text-[10px] text-eos-text-muted">
        ...
        {sorted.length > 6 && (
          <p className="mt-3 text-center text-xs text-eos-text-muted">
