  ...
  return (
    <div className="fixed inset-x-0 bottom-16 z-40">
      <div className="w-full px-4 md:px-6">
        <div className="flex flex-col gap-2 rounded-eos-md border border-eos-border-subtle bg-eos-surface/70 p-2 backdrop-blur supports-[backdrop-filter]:bg-eos-surface/55 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
          <Button
            size="lg"
