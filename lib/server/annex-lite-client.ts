  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      .sub { margin-top: 10px; color: var(--muted); line-height: 1.6; max-width: 800px; }
      .grid { display: grid; gap: 14px; }
      .hero-grid { margin-top: 24px; grid-template-columns: repeat(3, minmax(0, 1fr)); }
      .summary-card, .card { border: 1px solid var(--line); border-radius: 16px; background: #ffffff; }
      ...
      .toc-links a, .inline-link { color: var(--neutral); text-decoration: none; border-bottom: 1px solid var(--line); }
      .toc-links a:hover, .inline-link:hover { color: var(--ink); }
      @media print {
